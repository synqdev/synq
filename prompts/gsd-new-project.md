...
**After this command:** Run `/prompts:gsd-plan-phase 1` to start execution.
...
1. **Abort if project exists:**
   ```bash
   [ -f .planning/PROJECT.md ] && echo "ERROR: Project already initialized. Use /prompts:gsd-progress" && exit 1
   ```
...
- options:
  - "Map codebase first" — Run /prompts:gsd-map-codebase to understand existing architecture (Recommended)
  - "Skip mapping" — Proceed with project initialization

**If "Map codebase first":**
```
Run `/prompts:gsd-map-codebase` first, then return to `/prompts:gsd-new-project`
```
Exit command.
...
Use template: ./get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: ./get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: ./get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ./get-shit-done/templates/research-project/PITFALLS.md
</output>
...
`/prompts:gsd-discuss-phase 1` — gather context and clarify approach
...
**Also available:**
- `/prompts:gsd-plan-phase 1` — skip discussion, plan directly
...
- [ ] User knows next step is `/prompts:gsd-discuss-phase 1`
