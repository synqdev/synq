...
For deep ecosystem research ("how do experts build this"), use `/prompts:gsd-research-phase` which produces RESEARCH.md.
...
- Use `/prompts:gsd-research-phase` for these
</guidelines>
