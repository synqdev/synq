...
- This section feeds directly into /prompts:gsd-plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /prompts:gsd-plan-phase --gaps with root causes
...
**Creation:** When /prompts:gsd-verify-work starts new session
