...
- Example: `/prompts:gsd-add-phase Add authentication` → description = "Add authentication"
- Example: `/prompts:gsd-add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /prompts:gsd-add-phase <description>
Example: /prompts:gsd-add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /prompts:gsd-plan-phase {N} to break down)
...
- Don't use decimal numbering (that's /prompts:gsd-insert-phase)
- Don't create plans yet (that's /prompts:gsd-plan-phase)
