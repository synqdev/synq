...
- ./get-shit-done/references/verification-patterns.md (detection patterns)
- ./get-shit-done/templates/verification-report.md (output format)
</required_reading>
...
See ./get-shit-done/templates/verification-report.md for complete template.
</step>
