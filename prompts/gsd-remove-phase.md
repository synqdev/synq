...
- Example: `/prompts:gsd-remove-phase 17` → phase = 17
- Example: `/prompts:gsd-remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /prompts:gsd-remove-phase <phase-number>
Example: /prompts:gsd-remove-phase 17
```
...
To abandon current work, use /prompts:gsd-pause-work instead.
```
...
Would you like to:
- `/prompts:gsd-progress` — see updated roadmap status
