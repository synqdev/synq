...
description: Research how to implement a phase (standalone - usually use /prompts:gsd-plan-phase instead)
argument-hint: "[phase]"
allowed-tools:
  - Read
  - Bash
...
**Note:** This is a standalone research command. For most workflows, use `/prompts:gsd-plan-phase` which integrates research automatically.
...
<downstream_consumer>
Your RESEARCH.md will be loaded by `/prompts:gsd-plan-phase` which uses specific sections:
