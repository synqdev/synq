...
**Wave is pre-computed:** Wave numbers are assigned during `/prompts:gsd-plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
See `./get-shit-done/templates/user-setup.md` for full schema and examples
...
See `./get-shit-done/workflows/verify-phase.md` for verification logic.
