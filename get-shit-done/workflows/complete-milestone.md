...
2. Read `./get-shit-done/templates/milestone-archive.md` template
...
**Important:** The next milestone workflow starts with `/prompts:gsd-new-milestone` which includes requirements definition. PROJECT.md's Validated section carries the cumulative record across milestones.
...
- [ ] User knows next step (/prompts:gsd-new-milestone)
