...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /prompts:gsd-research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ./get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
7. **Create DISCOVERY.md** using ./get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ./get-shit-done/templates/discovery.md:
...
7. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ./get-shit-done/templates/discovery.md
...
Use ./get-shit-done/templates/discovery.md.
...
1. Discuss phase context (/prompts:gsd-discuss-phase [current-phase])
2. Create phase plan (/prompts:gsd-plan-phase [current-phase])
