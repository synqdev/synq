...
See `./get-shit-done/references/tdd.md` for TDD plan structure.
</tdd_plan_execution>
...
See ./get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `./get-shit-done/templates/user-setup.md`.
...
Use ./get-shit-done/templates/summary.md for structure.
...
For commit message conventions, see ./get-shit-done/references/git-integration.md
</step>
...
**Also available:**
- `/prompts:gsd-verify-work {phase}-{plan}` — manual acceptance testing before continuing
...
- `/prompts:gsd-discuss-phase {Z+1}` — gather context first
...
**Also available:**
- `/prompts:gsd-verify-work` — manual acceptance testing before completing milestone
- `/prompts:gsd-add-phase <description>` — add another phase before completing
